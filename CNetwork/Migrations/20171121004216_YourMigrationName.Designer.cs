...
namespace CNetwork.Migrations
{
    ...
    [Migration("20171121004216_YourMigrationName")]
            ...
            modelBuilder.Entity("CNetwork.Models.Invite", b =>
                {
                    ...
                    b.Property<int?>("AccepteridUser");

                    b.Property<int?>("FriendsidFriends");

                    b.Property<int?>("RequesteridUser");

                    b.Property<int>("idAccepter");

                    b.Property<int>("idRequester");

                    b.HasKey("idInvite");

                    b.HasIndex("AccepteridUser");

                    b.HasIndex("FriendsidFriends");

                    b.HasIndex("RequesteridUser");
