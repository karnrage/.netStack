...
// namespace quotingCheck.Connectors
namespace DbConnection

//All you may need to do is edit things like the Port variable, schema name, and the password depending on which system you are on.
{
